                    ...
                    <div className="compare-table table-responsive">
                      <table className="table table-bordered mb-0">
                        <tbody>
                          <tr>
                            ...
                            {compareItems.map((compareItem, key) => {
                              const cartItem = cartItems.find(
                                item => item.productId === compareItem.id
                              );
                              return (
                                <td className="product-image-title" key={key}>
                                  ...
                                  <div className="compare-btn">
                                    ...
                                    ) : compareItem.unitInStock &&
                                      compareItem.unitInStock > 0 ? (
                                      <button
                                        onClick={() =>
                          ...
                          <tr>
                            ...
                            {compareItems.map((compareItem, key) => {
                              const discountedPrice = getDiscountPrice(
                                compareItem.unitPrice,
                                compareItem.discount
                              );
                              const finalProductPrice = (
                                compareItem.unitPrice * currency.currencyRate
                              ).toFixed(2);
                          ...
                          <tr>
                            <th className="title-column">Miêu tả</th>
                            {compareItems.map((compareItem, key) => {
                              return (
                            ...
                            {compareItems.map((compareItem, key) => {
                              return (
                                <td className="product-rating" key={key}>
                                  <Rating ratingValue={compareItem.quality} />
                                </td>
                              );
                            })}
                          </tr>
