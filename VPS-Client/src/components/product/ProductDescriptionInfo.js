...
const ProductDescriptionInfo = ({
  ...
  const handleAddToCart = () => {
    const updatedProduct = {
      ...product,
      quantity: productCartQty >= productStock ? productStock : productCartQty + 1,
    };
            ...
            <div className="pro-details-size-content">
              {product.variation &&
                product.variation.map(single => {
                  return  single.size.map((singleSize, key) => {
                        return (
                          <label
      ...
      {product.category.categoryName ? (
        <div className="pro-details-meta">
          ...
          <ul style={{ backgroundColor: "black" , borderRadius: "10px" }}>
                ...
                <li >
                  <Link style={{ color: "white"}} to={process.env.PUBLIC_URL + "/shop-grid-standard"}>
                    {product.category.categoryName}
                  </Link>
                </li>
