...
const ProductDescriptionInfoSlider = ({
  ...
  // );
  const [productStock, setProductStock] = useState(product.unitInStock);
    ...
    <div className="product-details-content pro-details-slider-content">
                  ...
                  >
                    <input
                      ...
                      onChange={() => {
                        ...
                        setProductStock(single.size[0].unitInStock);
                        setQuantityCount(1);
                      }}
                    />
              ...
              {product.variation ? (
                        ...
                        return (
                          ...
                          >
                            <input
                              ...
                              onChange={() => {
                                setProductStock(singleSize.unitInStock);
                                setQuantityCount(1);
                              }}
                            />
                            <span className="size-name">
                              {singleSize.productName}
                            </span>
                          </label>
                        );
                      })
                ...
                <label className="pro-details-size-content--single">
                  <input
                    ...
                    value=""
                    onChange={() => {
                      setProductStock(product.unitInStock);
                      setQuantityCount(1);
                    }}
                  />
      ...
      {product.category.categoryName ? (
        <div className="pro-details-meta justify-content-center">
          ...
          <ul>
            {product.category.categoryName.map((single, key) => {
              return (
                <li key={key}>
